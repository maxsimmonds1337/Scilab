...
function [Gvuz,Gvus,Giuz,Gius]=Buck_ss_model_leading(L,rl,C,rc,Vg,D,Vload,Iload,Rload,tctrl,Fs,n_sub,mod)
    ...
    [A1,A0,b1,b0,c1,c0,V]=ConverterModels.Buck_matrix(L,rl,C,rc,Vg,D,Vload,Iload,Rload)

    //Propagate the states using the modulator
    [Gvuz,Gvus,Giuz,Gius]=ConverterModels.leadingPWM(A1,A0,b1,b0,c1,c0,V,D,tctrl,Fs,n_sub,mod)
