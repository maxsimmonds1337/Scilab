...
function [Gvuz,Gvus,Giuz,Gius]=Buck_ss_model_dual(L,rl,C,rc,Vg,D,Vload,Iload,Rload,tctrl,Fs,n_sub,mod)
    ...
    [Gvuz,Gvus,Giuz,Gius]=ConverterModels.dualPWM(A1,A0,b1,b0,c1,c0,V,D,tctrl,Fs,n_sub,mod)
